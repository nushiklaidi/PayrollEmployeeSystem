...
namespace PayrollEmployeeSystem.Data.Migrations
{
    ...
    [Migration("20200125141834_initialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayrollEmployeeSystem.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayrollEmployeeSystem.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayrollEmployeeSystem.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayrollEmployeeSystem.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PayrollEmployeeSystem.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayrollEmployeeSystem.Entity.TaxYear", "TaxYear")
                        .WithMany()
